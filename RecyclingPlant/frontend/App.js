...
import MachineManagement from './pages/MachineManagement'; // Import EditEmployee
...
import MaterialInventoryManagement from './pages/MaterialInventoryManagement';
...
import ManagerMaintenanceMatInvMan from './pages/ManagerMaintenanceMatInvMan';
...
import ManagerMaintenanceAddEmpAtt from './pages/ManagerMaintenanceAddEmpAtt';
...
import ManagerOperationsAddEmpAtt from './pages/ManagerOperationsAddEmpAtt';
        ...
        <Router>
            <Routes>
                <Route path="/" element={<Layout />}>
                    ...
                    <Route path="/admin/processes" element={<ProcessManagement />} />
                    ...
                    <Route path="/admin/material-inventory" element={<MaterialInventoryManagement />} />
                    ...
                    <Route path="/managermaintenance/material-inventory" element={<ManagerMaintenanceMatInvMan />} />
                    ...
                    <Route path="/managermaintenance/employee_attendance/add" element={<ManagerMaintenanceAddEmpAtt userRole="Manager-Maintenance" />} />
                    ...
                    <Route path="/manageroperations/employee_attendance/add" element={<ManagerOperationsAddEmpAtt userRole="Manager-Operations" />} />
