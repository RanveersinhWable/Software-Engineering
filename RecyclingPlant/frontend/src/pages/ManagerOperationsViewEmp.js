...
const ManagerOperationsViewEmp = ({ userRole }) => { // Accept userRole as a prop
                    ...
                    <tbody>
                        {employees.map((employee) => (
                            <tr key={employee.Employee_ID}>
                                ...
                                <td>
                                    <Link to={`/manageroperations/employees/edit/${employee.Employee_ID}`}>
...
export default ManagerOperationsViewEmp;
