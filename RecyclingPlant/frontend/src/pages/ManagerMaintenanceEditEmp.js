...
const ManagerMaintenanceEditEmp = ({ userRole }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`http://localhost:5000/api/employees/${id}?role=${userRole}`, formattedEmployee);
...
export default ManagerMaintenanceEditEmp;
