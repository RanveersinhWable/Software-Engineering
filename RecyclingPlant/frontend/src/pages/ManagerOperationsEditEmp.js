...
const ManagerOperationsEditEmp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`http://localhost:5000/api/employees/${id}?role=Manager-Operations`, formattedEmployee);
...
export default ManagerOperationsEditEmp;
