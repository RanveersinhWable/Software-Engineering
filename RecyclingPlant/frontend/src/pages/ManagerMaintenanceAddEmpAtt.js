...
const ManagerMaintenanceAddEmpAtt = ({ userRole }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Check user role and select the correct API
            if (userRole === 'Manager-Maintenance') {
                apiUrl = 'http://localhost:5000/api/employee_attendance/manager-maintenance';
            } else if (userRole === 'Manager-Operations') {
                apiUrl = 'http://localhost:5000/api/employee_attendance/manager-operations';
            } else {
...
export default ManagerMaintenanceAddEmpAtt;
