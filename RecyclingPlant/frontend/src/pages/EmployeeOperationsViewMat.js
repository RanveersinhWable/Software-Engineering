...
const EmployeeOperationsViewMat = () => {
                ...
                <tbody>
                    {materials.map(material => (
                        <tr key={material.Material_ID}>
                            ...
                            <td>
                                <Link to={`/employeeoperations/materials/edit/${material.Material_ID}?role={Employee-Operations}`}>
...
export default EmployeeOperationsViewMat;
